  ...
  return (
    <div className='homepage-wrapper'>
      <div className='banner-image-box'>
        <img alt="image" src="https://t4.ftcdn.net/jpg/03/36/15/67/240_F_336156751_XY1xfHvk9yl44dRS8opQeeexqvsebzby.jpg" />
      </div>
      ...
      <div className='image-wrapper'>
        ...
        <img className='img-fluid' alt="image" src={menImage} />
        <div className='text'>
          <h3>MEN</h3>
      ...
      <div className='image-wrapper'>
        ...
        <img className='img-fluid' alt="image" src={womenImage} />
        <div className='text'>
          <h3>WOMEN</h3>
